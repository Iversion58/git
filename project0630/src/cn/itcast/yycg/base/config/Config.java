package cn.itcast.yycg.base.config;
...
public class Config {
	 ...
	 * 工作流配置文件名
	 */
	public static final String 	FLOW = "diagram.purchasingflow";
	
	/**
	 * 采购流程定义key
	 */
	public static final String FLOW_KEY_PURCHASING = "purchasingProcessDefinitionKey";
