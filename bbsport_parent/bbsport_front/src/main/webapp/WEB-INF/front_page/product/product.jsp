...
<div class="w loc">
	<div class="h-title">
	    ...
	    <div class="h-search">
	        ...
	        <div class="h-se-btn"><a href="javascript:void(0)" onclick="serachKeyword()">搜索</a></div>
	    </div>
	</div>
		...
		<h2 class="h2 h2_filter mt"><em title="商品筛选">商品筛选</em><cite><a href="javascript:void(0);" id="filterRest" title="重置筛选条件">重置筛选条件</a></cite></h2>
			...
			<div class="mt ofc">
				...
				<c:forEach items="${pagination.list }" var="product">
					<li>
						<a href="productDetail.jsp" title="瑜伽服" target="_blank" class="pic"><img src="${product.img.allUrl }" alt="瑜伽服" /></a>
						<dl>
							<!-- dt 10个文字+... -->
